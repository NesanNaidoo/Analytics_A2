...
for(i in 1:nv){
  ...
  res_opt = nlm(obj_pen, theta_rand, iterlim = 500)
...
entropy error occurs at the regularization level of `r round(v_opt, 3)`, after which the validation error steadily increases. Therefore we will choose `r round(v_opt, 3)` as our regularization level. 
