...
## g) 
```{r, fig.cap= "Validation Error vs Regularisation Parameter(v) of the neural network", fig.pos="H", warning=FALSE, out.height=="85%", fig.asp=1, fig.align='center', fig.margin=FALSE}
set.seed(2025)
...
ggplot(plot_data, aes(x = v, y = ValidationError)) +
  ...
  theme(
    plot.margin = margin(0, 0, 0, 0, "pt"),  # Zero margin
    plot.title = element_blank(),             # Remove title space
    panel.border = element_blank(),          # Remove panel border
    panel.grid = element_blank(),            # Optional: remove grid lines
    axis.title = element_text(margin = margin(0, 0, 0, 0)))  # Tight axis titles
```
